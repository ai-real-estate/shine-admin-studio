  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-border bg-card text-foreground hover:bg-muted rounded-xl",
        ...
        google: "border border-border bg-card text-foreground hover:bg-muted rounded-xl font-medium",
        sidebar: "hover:bg-sidebar-accent text-sidebar-foreground rounded-lg justify-start",
        "sidebar-active": "bg-sidebar-accent text-sidebar-accent-foreground rounded-lg justify-start",
      },
      size: {
