  ...
  return (
    <div className="w-full max-w-md rounded-2xl border border-border bg-card p-8 shadow-card animate-fade-in">
      ...
      <div className="space-y-4">
        ...
        {/* Email Button */}
        <Button variant="default" size="lg" className="w-full gap-3">
      ...
      <p className="mt-6 text-center text-sm text-muted-foreground">
        ...
        <a href="#" className="font-medium text-foreground underline underline-offset-4 hover:text-foreground/80">
          Sign up
        </a>
      </p>
